package ir.markazandroid.uinitializr.network.JSONParser;
...
public class Parser {
    ...
    public Parser addClass(Class c) throws NoSuchMethodException {
    ...
    public Parser addSubClass(Class c) throws NoSuchMethodException {
